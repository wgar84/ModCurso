...
Esta ordenação representa a estrutura de relações empíricas associada ao atributo $T_{50}$, e conforme a hipótese, ela se associa à variação em coloração na população.
