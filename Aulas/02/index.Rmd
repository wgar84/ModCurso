...
<div class='centered'>
<img src='../Figuras/../../../Figuras/Homology.jpg' height=470px>
</div>

## Um exemplo mais extremo {.centered}
![[@tulenko_hoxd_2016]](../../../Figuras/forelimb_phylo.png)
...
<div class='centered'>
![[@yano_making_2013]](../../../Figuras/hox_homology.png)
</div>

## Homologias e Mapas Genótipo-Fenótipo {.centered}
![](../../../Figuras/gpmap_homology_1.png)

## Homologias e Mapas Genótipo-Fenótipo {.centered}
![](../../../Figuras/gpmap_homology_2.png)
...
## Exemplo: Coloração {.centered}
![](../../../Figuras/lizard_set_3.png)

## Medindo função {.centered}
![](../../../Figuras/forelimb_phylo.png)

## Medindo função {.centered}
![](../../../Figuras/forelimb_phylo_func.png)

## Do contexto teórico à mensuração {.centered}
![[@houle_measurement_2011]](../../../Figuras/theory_to_measurement.png)
