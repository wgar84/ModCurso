...
**Importante**: Idealmente, para todo código neste tutorial, seria bom você colar esse código em um *script* no RStudio e rodar o código mudando algumas coisas só para ver o que acontece.
...
No entanto, é importante notar que, qualquer que seja a operação feita com um vetor ou vetores, haverá duas formas de : uma relacionada a representá-los sob a forma de listas de números, outra relacionada a representá-los como setas.
