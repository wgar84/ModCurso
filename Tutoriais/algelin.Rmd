...
$$
\u = (0, -4); \quad \v = (2, 2); \quad \boldsymbol{w} = (-1, 3)
$$
...
$$
\u = (u_1, u_2); \v = (v_1, v_2) 
\Rightarrow \u + \v = (u_1 + v_1, u_2 + v_2)
$$
...
$$
\u = (u_1, u_2) \Rightarrow \alpha \cdot \u = (\alpha \cdot u_1, \alpha \cdot u_2)
$$
Neste contexto, chamamos de *escalar* este valor $\alpha$ que multiplica o vetor $\u$.
...
$$
\u = \begin{bmatrix} u_1 \\ u_2 \\ \end{bmatrix} \Rightarrow 
\u = u_1 \cdot \begin{bmatrix} 1 \\ 0 \\ \end{bmatrix} +
